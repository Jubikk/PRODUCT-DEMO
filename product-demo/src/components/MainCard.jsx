...
function MainCard({ products, onProductClick, currentPage, rowsPerPage, totalItems, onPageChange, onRowsPerPageChange, isLoading }) {
        ...
        <Box className="pt-6">
          {isLoading
            ? Array.from({ length: 5 }).map((_, i) => (
                <Paper key={i} elevation={3} sx={{ display: 'flex', alignItems: 'center', p: 2, mb: 2, borderRadius: 3 }}>
                  <Skeleton variant="rectangular" width={64} height={64} sx={{ borderRadius: 2, mr: 2 }} />
                  <Box sx={{ flex: 1 }}>
